SELECT
      ...
      +'&tt='+ dbo.fnCFDFlexFormatearImporte(Venta.Importe+ISNULL(Venta.Impuestos,0)-ISNULL(Venta.Retencion,0),10,6)
  ...
  LEFT JOIN CFDFolio CFO ON CFO.Modulo=MovTipo.Modulo AND CFO.Mov=MovTipo.Mov
WHERE Venta.ID = :ID
