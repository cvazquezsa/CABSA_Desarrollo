SELECT cxc.id,
      ...
      +'?id='+CAST(CFD.UUID AS VARCHAR(36))
      ...
      --'?re='+Cte.RFC + '&rr=' + Empresa.RFC + '&tt=' + 
      --dbo.fnCFDFlexFormatearImporte(Cxc.Importe+ISNULL(Cxc.Impuestos,0)-ISNULL(Cxc.Retencion,0),10,6)+
      --'&id='+CAST(CFD.UUID AS VARCHAR(36))
