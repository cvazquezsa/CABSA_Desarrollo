...
/* 09-01-2006 V.G.M. Se ingresaron las dimensiones de Plaza */
...
/* Se agrego línea para limpiar el cubo			Víctor Gutiérrez Méndez */
EXEC spLimpiarCubo   'NOM'
...
EXEC spInsertarDimensionNivel  'NOM','Mov','Mov','Mov','Mov',1
...
GO
EXEC spInsertarDimension 'NOM','Año','Normal','Año',1
EXEC spInsertarDimensionNivel  'NOM','Año','Año','Año','Año',1
GO
EXEC spInsertarDimension 'NOM','Mes','Normal','Mes',1
EXEC spInsertarDimensionNivel  'NOM','Mes','Mes','Mes','Mes',1
GO
/* 09-01-2007 Se ingresaron las dimensiones de Plaza, VigenciaA y VigenciaD		Víctor Gutiérrez Méndez*/
EXEC spInsertarDimension 'NOM','Plaza','Normal','Plaza',1
EXEC spInsertarDimensionNivel  'NOM','Plaza','Plaza','Plaza','Plaza',1
EXEC spInsertarDimensionNivel  'NOM','Plaza','Descripcion','Descripcion','Descripcion',2
EXEC spInsertarDimensionNivel  'NOM','Plaza','Tipo','Tipo','Tipo',3
EXEC spInsertarDimensionNivel  'NOM','Plaza','Rama','Rama','Rama',4
GO
EXEC spInsertarDimension 'NOM','VigenciaA','Normal','VigenciaA',1
EXEC spInsertarDimensionNivel  'NOM','VigenciaA','VigenciaA','VigenciaA','VigenciaA',1
GO
EXEC spInsertarDimension 'NOM','VigenciaD','Normal','VigenciaD',1
EXEC spInsertarDimensionNivel  'NOM','VigenciaD','VigenciaD','VigenciaD','VigenciaD',1
GO
...
--  'Sucursal' 		= n.Sucursal,
  ...
  'EstatusPersonal'	= p.Estatus,
   pza.plaza, pza.descripcion, pza.Tipo, pza.Rama, pza.VigenciaA, pza.VigenciaD
...
--	LEFT OUTER JOIN  Sucursal su	ON n.Sucursal	= su.Sucursal
	LEFT OUTER JOIN  Sucursal su	ON p.SucursalTrabajo	= su.Sucursal
