...
/**************** spOrganizaVerificar ****************/
if exists (select * from sysobjects where id = object_id('dbo.spOrganizaVerificar') and type = 'P') drop procedure dbo.spOrganizaVerificar
GO
CREATE PROCEDURE spOrganizaVerificar
    		    @ID               		int,
		    @Accion			char(20),
    		    @Empresa          		char(5),
		    @Usuario			char(10),
...
/**************** spOrganizaAfectar ****************/
if exists (select * from sysobjects where id = object_id('dbo.spOrganizaAfectar') and type = 'P') drop procedure dbo.spOrganizaAfectar
GO             
CREATE PROCEDURE spOrganizaAfectar
    		   @ID                		int,
...
/**************** spOrganiza ****************/
if exists (select * from sysobjects where id = object_id('dbo.spOrganiza') and type = 'P') drop procedure dbo.spOrganiza
GO
CREATE PROCEDURE spOrganiza
                   @ID                  	int,
    		   @Modulo	      		char(5),
		   @Accion			char(20),
		   @Base			char(20),
