...
-- spCapturaFoto 1, 'Cte', 'C1', 1
-- spCapturaFoto 1, 'Cte', 'C1', 0
/**************** spCapturaFoto ****************/
if exists (select * from sysobjects where id = object_id('dbo.spCapturaFoto') and type = 'P') drop procedure dbo.spCapturaFoto
GO
CREATE PROCEDURE spCapturaFoto
    		    @ID               	int,
		    @Tabla		varchar(100),
		    @Clave		varchar(50),
		    @Accion		varchar(20)	
...
/**************** spCapturaVerificar ****************/
if exists (select * from sysobjects where id = object_id('dbo.spCapturaVerificar') and type = 'P') drop procedure dbo.spCapturaVerificar
GO
CREATE PROCEDURE spCapturaVerificar
...
/**************** spCapturaAfectar ****************/
if exists (select * from sysobjects where id = object_id('dbo.spCapturaAfectar') and type = 'P') drop procedure dbo.spCapturaAfectar
GO             
CREATE PROCEDURE spCapturaAfectar
    		   @ID                		int,
...
/**************** spCaptura ****************/
if exists (select * from sysobjects where id = object_id('dbo.spCaptura') and type = 'P') drop procedure dbo.spCaptura
GO
CREATE PROCEDURE spCaptura
                   @ID                  	int,
    		   @Modulo	      		char(5),
		   @Accion			char(20),
		   @Base			char(20),
