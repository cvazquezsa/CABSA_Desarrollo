...
Boton=0
TipoAccion=Expresion
Expresion=EjecutarSQL(<T>spCopiarPOSperfil :tAcceso,:tUsuario<T>,POSUsuario:POSUsuario.POSPerfil,POSUsuario:POSUsuario.Usuario )     
Activo=S
Visible=S
...
[Default.POSUsuario.DefCtaDineroTrans]
Carpeta=Default
Clave=POSUsuario.DefCtaDineroTrans
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
POSUsuario.DefAlmacen=POSUsuario.DefCtaDinero
POSUsuario.DefCtaDinero=POSUsuario.DefMoneda
POSUsuario.DefMoneda=POSUsuario.DefCtaDineroTrans
POSUsuario.DefCtaDineroTrans=POSUsuario.DefCliente
POSUsuario.DefCliente=POSUsuario.DefAgente
POSUsuario.DefAgente=POSUsuario.DefListaPreciosEsp
POSUsuario.DefListaPreciosEsp=POSUsuario.UEN
POSUsuario.UEN=POSUsuario.DefZonaImpuesto
