[Forma]
Clave=mis_RepCxcAnalisisMov
Nombre=General de Movimientos   ( CXC )
Icono=0
Modulos=(Todos)
...
ListaAccionesMultiples=Variables Asignar<BR>mis_CxcAnalisisMov
Activo=S
Visible=S
...
[Acciones.Imprimir.mis_CxcAnalisisMov]
Nombre=mis_CxcAnalisisMov
Boton=0
TipoAccion=Reportes Impresora
ClaveAccion=mis_CxcAnalisisMov

[Acciones.Preliminar.mis_CxcAnalisisMov]
Nombre=mis_CxcAnalisisMov
Boton=0
