...
Nombre=<T>Existencias Disponibles del Cliente<T>
Icono=44
Modulos=INV
ListaCarpetas=Lista
...
VentanaEscCerrar=S
BarraHerramientas=S
Comentarios=Lista(Info.Cliente, e(<T>Almacén<T>)+<T>: <T>+Si(ConDatos(Info.Almacen), Info.Almacen, <T>(Todos)<T>))
...
IconosNombre=ArtConDisponibleCte:Art.Articulo
...
Visible=S
EspacioPrevio=S
AntesExpresiones=Asigna( Info.Articulo,ArtConDisponibleCte:Art.Articulo )<BR>Asigna( Info.ArtTipo, ArtConDisponibleCte:Tipo)
...
Antes=S
Visible=S
EjecucionCondicion=ConDatos(ArtConDisponibleCte:Art.Articulo)
AntesExpresiones=Asigna(Info.Articulo, ArtConDisponibleCte:Art.Articulo)<BR>Asigna(Info.Disponible, ArtConDisponibleCte:Disponible)
