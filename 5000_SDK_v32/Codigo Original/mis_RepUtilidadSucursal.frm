...
ExpresionesAlMostrar=Asigna(Info.Sucursal, Nulo)<BR>Asigna(Info.Desglosar, <T>No<T>)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
...
ListaAccionesMultiples=Variables Asignar<BR>mis_UtilidadSucursal
Activo=S
Visible=S
...
[Acciones.Preliminar.mis_UtilidadSucursal]
