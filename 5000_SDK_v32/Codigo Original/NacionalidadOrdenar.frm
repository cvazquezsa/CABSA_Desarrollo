[Forma]
Clave=NacionalidadOrdenar
Nombre=Ordenar Nacionalidad
Icono=48
Modulos=(Todos)
ListaCarpetas=Lista
...
IconosNombre=Nacionalidad:Nacionalidad.Orden
...
ClaveAccion=Cerrar
Antes=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>Nacionalidad.Nacionalidad<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla<T>, EstacionTrabajo, <T>Nacionalidad<T>)
