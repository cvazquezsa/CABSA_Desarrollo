...
[Acciones.RepPan.RepKardexPEPS]
Nombre=RepKardexPEPS
Boton=0
...
Expresion=ReportePantalla(<T>RepInvKardexPEPS<T>)
[Acciones.Imprimir.RepKardexPEPS]
Nombre=RepKardexPEPS
Boton=0
TipoAccion=Expresion
Expresion=ReporteImpresora(<T>RepInvKardexPEPS<T>)
Activo=S
Visible=S
...
Variables Asignar=RepKardexPEPS
RepKardexPEPS=(Fin)
