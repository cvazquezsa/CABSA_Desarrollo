...
IconosNombre=MovCte:MovCte.Orden
...
NombreEnBoton=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>MovCte.Nombre<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla<T>, EstacionTrabajo, <T>MovCte<T>)
