[Forma]
Clave=FormaPagoOrdenar
Nombre=Ordenar Formas Pago
Icono=48
Modulos=(Todos)
ListaCarpetas=Lista
...
ListaOrden=FormaPago.Orden<TAB>(Acendente)
IconosNombre=FormaPago:FormaPago.Orden
...
ClaveAccion=Cerrar
Antes=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>FormaPago.FormaPago<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla<T>, EstacionTrabajo, <T>FormaPago<T>)
