...
Visible=S
Menu=&Archivo
Expresion=Si(Explorar.Modulo en (<T>VTAS<T>, <T>INV<T>, <T>COMS<T>, <T>NOM<T>), ReportePantalla(<T>VerAuxU<T>), ReportePantalla(<T>VerAux<T>))
...
Visible=S
EspacioPrevio=S
Expresion=Si(Explorar.Modulo en (<T>VTAS<T>, <T>INV<T>, <T>COMS<T>, <T>NOM<T>), ReporteImpresora(<T>VerAuxU<T>), ReporteImpresora(<T>VerAux<T>))
...
ConCondicion=S
Visible=S
Expresion=ReportePantalla(VerAux:Modulo, VerAux:ModuloID)
ActivoCondicion=Explorar.Nivel en (<T>Movimiento<T>, <T>Aplicacion<T>)
EjecucionCondicion=ConDatos(VerAux:ModuloID)
...
Activo=S
EjecucionCondicion=ConDatos(VerAux:ModuloID)
AntesExpresiones=Asigna(Info.Modulo, VerAux:Modulo)<BR>Asigna(Info.ID, VerAux:ModuloID)
