[Forma]
Clave=LCCte
Nombre=Líneas de Crédito del Cliente
Icono=0
Modulos=(Todos)
ListaCarpetas=Lista
...
FiltroGeneral=LC.Express=0 AND LC.Uso IN (<T>Colocacion<T>) AND (LC.Acreditado=<T>{Info.Cliente}<T> OR LC.Coacreditado=<T>{Info.Cliente}<T>)
