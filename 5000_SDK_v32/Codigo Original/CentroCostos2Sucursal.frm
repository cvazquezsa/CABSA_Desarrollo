...
CarpetaVisible=S
PermiteEditar=S
FiltroGeneral=CentroCostos2Sucursal.CentroCostos2=<T>{Info.CentroCostos2}<T>

[Lista.CentroCostos2Sucursal.Sucursal]
Carpeta=Lista
...
(Inicio)=CentroCostos2Sucursal.Sucursal
CentroCostos2Sucursal.Sucursal=Sucursal.Nombre
Sucursal.Nombre=(Fin)
