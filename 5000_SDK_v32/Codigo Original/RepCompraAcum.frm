...
ExpresionesAlMostrar=Asigna(Info.Articulo, Nulo)<BR>Asigna(Info.Proveedor, Nulo)<BR>Asigna(Info.Ejercicio, EjercicioTrabajo)<BR>Asigna(Info.Desglosar, <T>No<T>)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
...
Activo=S
Visible=S
Expresion=IrEjercicio(Info.Ejercicio)<BR>IrDireccion(<T>COMS<T>, Info.Articulo, Info.Proveedor, Si(ConDatos(Info.Proveedor),Falso,Info.Desglosar<><T>No<T>))
...
Info.Ejercicio=Info.Proveedor
Info.Proveedor=Info.Desglosar
Info.Desglosar=(Fin)
