...
ListaParametros=S
ListaParametros1=<T>Importar Archivo Conciliación<T><BR><T>ListaSt<T><BR><T>Estacion<T><BR><T>ID<T><BR><T>spConciliacionImportar<T><BR>EstacionTrabajo & <T>, <T> & hConciliacion:hConciliacion.ID<BR>Falso
GuardarAntes=S
RefrescarDespues=S
