...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Nomina:Nomina.Usuario) y <BR>(Nomina:Nomina.Estatus en (EstatusSinAfectar, EstatusPorConfirmar, EstatusBorrador)) y<BR>PuedeAvanzarEstatus(<T>NOM<T>, Nomina:Nomina.Mov, Nomina:Nomina.Estatus, FormaSituacion)
...
Antes=S
AntesExpresiones=Asigna(Info.Mov,Nomina:Nomina.Mov)
[Acciones.Imprimir]
Nombre=Imprimir
Boton=4
Menu=&Archivo
...
Antes=S
Visible=S
ActivoCondicion=(ConfigModulo(<T>NOM<T>,<T>Situaciones<T>)=<T>Si<T>) y Usuario.ModificarSituacion y<BR>PuedeAvanzarSituacion(<T>NOM<T>, Nomina:Nomina.Mov, Nomina:Nomina.Estatus, FormaSituacion)
...
[Acciones.NominaG4ErroresCFG]
Nombre=NominaG4ErroresCFG
Boton=101
NombreDesplegar=Log Errores CFG
EnBarraHerramientas=S
TipoAccion=Formas
ClaveAccion=NominaG4ErroresCFG
Activo=S
...
Otros7=Otros8
Otros8=Otros9
Otros9=NominaG4ErroresCFG
NominaG4ErroresCFG=(Fin)
