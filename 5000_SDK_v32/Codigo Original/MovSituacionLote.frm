...
Visible=S
ConCondicion=S
EjecucionCondicion=ConDatos(MovSituacion:MovSituacion.Situacion)
Antes=S
AntesExpresiones=Asigna(Info.Situacion, MovSituacion:MovSituacion.Situacion)
