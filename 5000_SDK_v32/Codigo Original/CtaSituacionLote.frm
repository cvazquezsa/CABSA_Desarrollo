...
ListaEnCaptura=CtaSituacion.Situacion
CarpetaVisible=S
Filtros=S
FiltroPredefinido=S
FiltroAncho=30
...
Visible=S
ConCondicion=S
EjecucionCondicion=ConDatos(CtaSituacion:CtaSituacion.Situacion)
Antes=S
AntesExpresiones=Asigna(Info.Situacion, CtaSituacion:CtaSituacion.Situacion)
