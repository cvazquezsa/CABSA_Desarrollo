...
MenuLocal=S
ListaAcciones=(Lista)
IconosNombre=CompraPedimento:Articulo
...
ConCondicion=S
Visible=S
EjecucionCondicion=RegistrarSeleccionIDRenglon(<T>Lista<T>, <T>Modulo<T>, <T>ID<T>, <T>Renglon<T>, <T>RenglonSub<T>) <BR>Forma(<T>CompraAsignarPedimento<T>)
