[Forma]
Clave=VentaMovActividadCostoInfo
Nombre=Actividades del Movimiento
Icono=0
Modulos=(Todos)
ListaCarpetas=Lista
CarpetaPrincipal=Lista
PosicionInicialIzquierda=76
...
PosicionSeccion1=91
VentanaExclusiva=S
ExpresionesAlMostrar=EjecutarSQL(<T>spSugerirTodasActividades :tEmpresa, :tModulo, :nID<T>, Empresa, <T>VTAS<T>, Info.ID)
...
Totalizadores1=Conteo<BR>Tiempo<BR>Estándar<BR>Diferencia<BR>Costo
Totalizadores2=Conteo<BR>MinutosEnHoras(Suma(VentaDAgente:VentaDAgente.Minutos))<BR>MinutosEnHoras(Suma(VentaDAgente:VentaDAgente.CantidadEstandar*60))<BR>MinutosEnHoras(Suma(VentaDAgente:VentaDAgente.Minutos)-Suma(VentaDAgente:VentaDAgente.CantidadEstandar*60))<BR>Suma(VentaDAgente:CostoTotal)
Totalizadores=S
...
ListaEnCaptura=(Lista)
CarpetaVisible=S
Totalizadores3=<BR><BR><BR><BR>(Monetario)
...
VentaDAgente.Estado=VentaDAgente.FechaConclusion
