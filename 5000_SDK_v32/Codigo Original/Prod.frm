...
[Ficha.Prod.PosicionDWMS]
Carpeta=Ficha
Clave=Prod.PosicionDWMS
Editar=S
LineaNueva=N
ValidaNombre=N
3D=S
...
Prod.Almacen=Prod.CrossDocking
Prod.CrossDocking=Prod.FechaEntrega
Prod.FechaEntrega=Prod.PosicionDWMS
Prod.PosicionDWMS=Prod.Concepto
...
[Ficha.Prod.CrossDocking]
Carpeta=Ficha
Clave=Prod.CrossDocking
Editar=S
ValidaNombre=S
3D=S
ColorFondo=Blanco
