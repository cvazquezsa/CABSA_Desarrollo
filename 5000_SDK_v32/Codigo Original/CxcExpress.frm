...
ActivoCondicion=PuedeAfectar(Usuario.Afectar, Usuario.AfectarOtrosMovs, Cxc:Cxc.Usuario) y<BR>(Cxc:Cxc.Estatus=EstatusSinAfectar) y<BR>fnPuedeAvanzarEstatus(Empresa, <T>CXC<T>, Cxc:Cxc.Mov, Cxc:Cxc.Estatus, FormaSituacion, Usuario)
