...
FiltroRespetar=S
FiltroTipo=General
IconosNombre=Causa:Causa.Orden
...
NombreEnBoton=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>Causa.Causa<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla, :tModulo<T>, EstacionTrabajo, <T>Causa<T>, Info.Modulo)
