...
ListaAcciones=(Lista)
CarpetaVisible=S
IconosNombre=ArtSubDisponibleDesc:Art.Articulo
FiltroGeneral=ArtSubDisponibleDesc.Empresa=<T>{Empresa}<T> AND ArtSubDisponibleDesc.Almacen=<T>{Info.Almacen}<T> AND ArtSubDisponibleDesc.Disponible>0
...
[Lista.ArtSubDisponibleDesc.Disponible]
Carpeta=Lista
...
NombreEnBoton=S
Antes=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>ArtSubDisponibleDesc.Llave<T>)<BR>EjecutarSQL(<T>spArtDisponibleAsignar :nEstacion, :nID, :tEmp, :tAlm, 0<T>, EstacionTrabajo, Info.ID, Empresa, Info.Almacen)

[Acciones.Disponible]
Nombre=Disponible
Boton=23
NombreEnBoton=S
NombreDesplegar=Agregar + &Disponible
EnBarraHerramientas=S
TipoAccion=Ventana
ClaveAccion=Aceptar
Activo=S
Visible=S
Antes=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>ArtSubDisponibleDesc.Llave<T>)<BR>EjecutarSQL(<T>spArtDisponibleAsignar :nEstacion, :nID, :tEmp, :tAlm, 1<T>, EstacionTrabajo, Info.ID, Empresa, Info.Almacen)

[Lista.ArtSubDisponibleDesc.SubCuenta]
Carpeta=Lista
...
(Inicio)=ArtSubDisponibleDesc.SubCuenta
ArtSubDisponibleDesc.SubCuenta=Art.Descripcion1
Art.Descripcion1=ArtSubDisponibleDesc.Disponible
ArtSubDisponibleDesc.Disponible=(Fin)
