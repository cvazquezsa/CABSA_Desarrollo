...
Visible=S
Antes=S
AntesExpresiones=RegistrarSeleccionID(<T>Lista<T>)<BR>EjecutarSQL(<T>spCteEventoDAsignar :nEstacion, :tCte<T>, EstacionTrabajo, Info.Cliente)
