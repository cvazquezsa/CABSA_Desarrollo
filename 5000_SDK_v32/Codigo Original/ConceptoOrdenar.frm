[Forma]
Clave=ConceptoOrdenar
Icono=48
Modulos=(Todos)
VentanaTipoMarco=Normal
VentanaPosicionInicial=Centrado
VentanaExclusiva=S
Nombre=Ordenar Conceptos
BarraHerramientas=S
...
FiltroRespetar=S
FiltroTipo=General
IconosNombre=Concepto:Concepto.Orden
...
NombreEnBoton=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>Concepto.Concepto<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla, :tModulo<T>, EstacionTrabajo, <T>Concepto<T>, Info.Modulo)
