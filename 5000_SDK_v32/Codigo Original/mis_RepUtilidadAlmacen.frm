...
ExpresionesAlMostrar=Asigna(Info.Almacen, <T>(TODOS)<T>)<BR>Asigna(Info.Desglosar, <T>No<T>)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
...
ListaAccionesMultiples=Variables Asignar<BR>mis_UtilidadAlmacen
Activo=S
Visible=S
...
[Acciones.Preliminar.mis_UtilidadAlmacen]
Nombre=mis_UtilidadAlmacen
Boton=0
