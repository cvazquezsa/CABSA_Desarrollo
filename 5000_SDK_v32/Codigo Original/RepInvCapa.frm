...
ExpresionesAlMostrar=Asigna(Info.ArticuloD, Nulo) <BR>Asigna(Info.ArticuloA, Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
...
Visible=S
Multiple=S
ListaAccionesMultiples=Variables Asignar<BR>InvCapa
NombreEnBoton=S
EspacioPrevio=S
