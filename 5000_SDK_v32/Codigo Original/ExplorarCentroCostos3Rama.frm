[Forma]
Clave=ExplorarCentroCostos3Rama
Nombre=<T>Explorando - Centros de Costos 3<T>
Icono=47
Modulos=(Todos)
ListaCarpetas=Lista
...
ExpresionesAlMostrar=Asigna(Info.ContMoneda, Config.ContMoneda)<BR>Asigna(Info.Vista, <T>Resumen<T>)<BR>IrModulo(<T>CC3<T>)
...
Filtros=S
FiltroPredefinido=S
FiltroArbolClave=CentroCostos3
FiltroArbolValidar=Descripcion
FiltroArbolRama=Rama
FiltroArbolAcumulativas=EsAcumulativo
FiltroAncho=30
FiltroTipo=Arbol
FiltroEnOrden=S
...
TablaIndependiente=CentroCostos3
...
EnMenu=S
TipoAccion=Formas
ClaveAccion=ExplorarCentroCostos3Cta
Activo=S
Visible=S
Antes=S
UsaTeclaRapida=S
