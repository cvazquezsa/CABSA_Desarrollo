...
FiltroTipo=General
CarpetaVisible=S
FiltroGeneral=ArtDescuentoCompra.Articulo=<T>{Info.Articulo}<T>

[Lista.ArtDescuentoCompra.Porcentaje]
Carpeta=Lista
...
GuardarAntes=S
Antes=S
AntesExpresiones=EjecutarSQL(<T>spArtDescuentoCompra :tArt<T>, Info.Articulo)
DespuesGuardar=S

[Lista.ArtDescuentoCompra.Concepto]
Carpeta=Lista
...
(Inicio)=ArtDescuentoCompra.Porcentaje
