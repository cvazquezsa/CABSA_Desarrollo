...
EjecucionCondicion=Asigna(Info.Porcentaje, (Suma(EmbarqueDArtCompra:EmbarqueDArt2.Cantidad*EmbarqueDArtCompra:EmbarqueDArt2.ImporteTotal)/Suma(EmbarqueDArtCompra:EmbarqueDArt2.CantidadTotal*EmbarqueDArtCompra:EmbarqueDArt2.ImporteTotal))*100)<BR>(Info.Porcentaje>=0) y (Info.Porcentaje<=100)
