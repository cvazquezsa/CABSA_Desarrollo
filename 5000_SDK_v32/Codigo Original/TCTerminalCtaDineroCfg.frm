...
MovModulo=(Todos)
Nombre=Tarjetas Bancarias - Configuración Terminales por Caja
Comentarios=Lista(Empresa, Info.CtaDinero)
PosicionCol1=188
...
FiltroRespetar=S
FiltroTipo=General
FiltroGeneral=TCTerminalCfg.CtaDinero = <T>{Info.CtaDinero}<T>
