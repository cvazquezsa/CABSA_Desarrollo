...
[(Variables).Info.SugerirCobroCapital]
Carpeta=(Variables)
Clave=Info.SugerirCobroCapital
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
(Inicio)=Info.SugerirCobroCapital
Info.SugerirCobroCapital=Info.Importe
Info.Importe=(Fin)
