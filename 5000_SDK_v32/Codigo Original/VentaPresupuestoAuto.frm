[Forma]
Clave=VentaPresupuestoAuto
Icono=0
Modulos=(Todos)
Nombre=<T>Generar Presupuesto del Periodo - Ventas<T>
MovModulo=(Todos)
...
Activo=S
Visible=S
Expresion=ProcesarSQL(<T>xpVentaPresupuestoAuto :tE, :nA, :nPD, :nPA, :tU<T>, Empresa, Info.Ejercicio, Info.PeriodoD, Info.PeriodoA, Usuario)
