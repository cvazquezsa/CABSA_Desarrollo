...
PosicionInicialAncho=1009
VentanaTipoMarco=Diálogo
VentanaPosicionInicial=Centrado
VentanaEstadoInicial=Normal
PosicionInicialIzquierda=1367
...
FuenteDesplegar={Segoe UI, 9, Blanco, []}
...
GuardarAntes=S
TipoAccion=Formas
ClaveAccion=POSLVentaEmbarques
Antes=S
DespuesGuardar=S
...
AntesExpresiones=Asigna(Info.Articulo,POSLVenta:POSLVenta.Articulo)<BR>Asigna(Info.IDTexto,POSLVenta:POSLVenta.ID)<BR>Asigna(Info.SubCuenta,POSLVenta:POSLVenta.SubCuenta)<BR>Asigna(Info.Cantidad,POSLVenta:POSLVenta.Cantidad)<BR>Asigna(Info.ArtTipo,POSLVenta:Art.Tipo)<BR>Asigna(Info.RenglonID,POSLVenta:POSLVenta.RenglonID)<BR>Asigna(Info.Renglon,POSLVenta:POSLVenta.Renglon)<BR>Asigna(Info.Cantidad,POSLVenta:POSLVenta.Cantidad)<BR>Asigna(Info.Cliente,SQL(<T>SELECT Cliente FROM POSL WHERE ID =:tIDS<T>, POSLVenta:POSLVenta.ID))
