[Forma]
Clave=ChryslerGenerarBonificaciones
Nombre=Generar Bonificaciones
Icono=0
Modulos=(Todos)
...
Activo=S
Visible=S
Expresion=ProcesarSQL(<T>spGenerarBonificacionesChrysler :tEmpresa, :nSucursal, :tUsuario, :nEjercicio, :nPeriodo<T>, Empresa, Sucursal, Usuario, Info.Ejercicio, Info.Periodo)
