...
Multiple=S
EnBarraAcciones=S
ListaAccionesMultiples=Variables Asignar<BR>InvAux
Activo=S
Visible=S
NombreEnBoton=S
...
Activo=S
Visible=S
Expresion=Caso Rep.Aux<BR>  Es <T>Concentrado<T> Entonces ReporteImpresora(<T>InvAuxConcentrado<T>, Info.ArticuloD, Info.ArticuloA, Info.FechaD, Info.FechaA)<BR>  Es <T>Desglosado<T> Entonces ReporteImpresora(<T>InvAux<T>,   Info.ArticuloD, Info.ArticuloA, Info.FechaD, Info.FechaA)<BR>  Es <T>Desglosado por Dia<T> Entonces ReporteImpresora(<T>InvAuxDia<T>, Info.ArticuloD, Info.ArticuloA, Info.FechaD, Info.FechaA)<BR>Fin
...
Info.ArtLinea=Rep.InvAuxUMov
Rep.InvAuxUMov=Rep.Aux
Rep.Aux=Info.Moneda
