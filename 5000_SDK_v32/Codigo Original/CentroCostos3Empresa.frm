...
CarpetaVisible=S
PermiteEditar=S
FiltroGeneral=CentroCostos3Empresa.CentroCostos3=<T>{Info.CentroCostos3}<T>

[Lista.CentroCostos3Empresa.Empresa]
Carpeta=Lista
...
(Inicio)=CentroCostos3Empresa.Empresa
CentroCostos3Empresa.Empresa=Empresa.Nombre
Empresa.Nombre=(Fin)
