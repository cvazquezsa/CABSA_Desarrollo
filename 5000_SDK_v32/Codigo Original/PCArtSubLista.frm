...
FiltroGeneral=ListaPreciosSub.Lista=<T>{Info.Lista}<T>
...
Visible=S
Antes=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>Llave<T>)<BR>EjecutarSQL(<T>spPCArtListaAceptar :nEstacion, :nID<T>, EstacionTrabajo, Info.ID)
