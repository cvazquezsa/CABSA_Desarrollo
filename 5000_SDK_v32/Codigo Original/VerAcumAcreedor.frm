...
EjecucionCondicion=(VerAcumAcreedor:Periodo>=1) y (VerAcumAcreedor:Periodo<>999)
AntesExpresiones=IrDesglose(VerAcumAcreedor:Ejercicio, VerAcumAcreedor:Periodo, VerAcumAcreedor:Moneda, <T>Dia<T>, <T>Normal<T>)
...
Activo=S
Visible=S
Expresion=Si(Explorar.Modulo en (<T>VTAS<T>, <T>INV<T>, <T>COMS<T>, <T>NOM<T>), ReporteImpresora(<T>VerAcumAcreedorU<T>), ReporteImpresora(<T>VerAcumAcreedor<T>))
...
Activo=S
Visible=S
Expresion=Si(Explorar.Modulo en (<T>VTAS<T>, <T>INV<T>, <T>COMS<T>, <T>NOM<T>), ReportePantalla(<T>VerAcumAcreedorU<T>), ReportePantalla(<T>VerAcumAcreedor<T>))
