[Forma]
Clave=ExplorarCentroCostos2Rama
Nombre=<T>Explorando - Centros de Costos 2<T>
Icono=47
Modulos=(Todos)
ListaCarpetas=Lista
...
ExpresionesAlMostrar=Asigna(Info.ContMoneda, Config.ContMoneda)<BR>Asigna(Info.Vista, <T>Resumen<T>)<BR>IrModulo(<T>CC2<T>)
...
Filtros=S
FiltroPredefinido=S
FiltroArbolClave=CentroCostos2
...
TablaIndependiente=CentroCostos2
...
EnMenu=S
TipoAccion=Formas
ClaveAccion=ExplorarCentroCostos2Cta
Activo=S
Visible=S
Antes=S
UsaTeclaRapida=S
