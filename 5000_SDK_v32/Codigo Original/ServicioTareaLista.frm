...
Antes=S
Visible=S
AntesExpresiones=Asigna(Info.Problema, ServicioTareaLista:Problema)
...
NombreEnBoton=S
Antes=S
AntesExpresiones=Asigna(Info.Solucion, ServicioTareaLista:Solucion)
...
Visible=S
Antes=S
AntesExpresiones=Asigna(Info.Problema, ServicioTareaLista:Problema)<BR>Asigna(Info.Solucion, ServicioTareaLista:Solucion)
