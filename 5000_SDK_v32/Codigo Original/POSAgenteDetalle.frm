...
ExpresionesAlCerrar=Asigna(Info.Codigo, nulo)EjecutarSQL(<T>spPOSInicializar  :tEmpresa, :nSucursal, :tUsuario, :nEstacion, :tID<T>,Empresa, Sucursal, Usuario, EstacionTrabajo, Info.IDTexto)
[Principal]
Estilo=Ficha
PestanaOtroNombre=S
Clave=Principal
