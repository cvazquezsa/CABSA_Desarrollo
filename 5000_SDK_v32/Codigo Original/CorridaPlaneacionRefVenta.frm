[Forma]
Clave=CorridaPlaneacionRefVenta
Icono=0
Modulos=(Todos)
ListaCarpetas=Lista
...
ListaEnCaptura=Info.PlanReferenciaVenta
CarpetaVisible=S
...
Activo=S
Visible=S
Expresion=Asigna(Info.PlanReferenciaModulo, <T>VTAS<T>)<BR>Asigna(Info.PlanReferencia, Info.PlanReferenciaVenta)<BR>Dialogo(<T>CorridaPlaneacion<T>)
...
[Lista.Info.PlanReferenciaVenta]
Carpeta=Lista
Clave=Info.PlanReferenciaVenta
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
