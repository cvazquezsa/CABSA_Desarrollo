...
Visible=S
NombreEnBoton=S
Expresion=Asigna(Info.SubSubEvaluacion, EvaluacionCto:EvaluacionFormato.Referencia)<BR>Forma(<T>EvaluacionCtoSubSubInfo<T>)
