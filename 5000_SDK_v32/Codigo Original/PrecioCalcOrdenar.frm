[Forma]
Clave=PrecioCalcOrdenar
Icono=48
Modulos=(Todos)
VentanaTipoMarco=Normal
VentanaPosicionInicial=Centrado
VentanaExclusiva=S
Nombre=Ordenar Precios Calculados
BarraHerramientas=S
...
IconosNombre=PrecioCalc:PrecioCalc.Orden
...
NombreEnBoton=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>PrecioCalc.ListaPrecios<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla<T>, EstacionTrabajo, <T>PrecioCalc<T>)
