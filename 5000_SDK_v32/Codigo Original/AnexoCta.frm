...
IconosNombre=AnexoCta:AnexoCta.Nombre
...
EnMenu=S
EsDefault=S
Expresion=Caso AnexoCta:AnexoCta.Tipo<BR>  Es <T>Comentario<T> Entonces VerComentario(AnexoCta:AnexoCta.Nombre+<T> - <T>+Info.Descripcion, AnexoCta:AnexoCta.Comentario) <BR>  Es <T>Mensaje<T>    Entonces VerComentario(AnexoCta:AnexoCta.Nombre+<T> - <T>+Info.Descripcion, AnexoCta:AnexoCta.Comentario) <BR>  Es <T>Imagen<T>     Entonces VerImagen(AnexoCta:AnexoCta.Nombre+<T> - <T>+Info.Descripcion, AnexoCta:AnexoCta.Direccion)<BR>Sino<BR>  URL(AnexoCta:AnexoCta.Direccion)<BR>Fin
VisibleCondicion=ConDatos(AnexoCta:AnexoCta.Nombre)
