...
ListaEnCaptura=MFAConceptoGASCfg.Concepto
FiltroPredefinido=S
FiltroAncho=40
...
CarpetaVisible=S
OtroOrden=S
ListaOrden=MFAConceptoGASCfg.Orden<TAB>(Acendente)
PermiteLocalizar=S
HojaMantenerSeleccion=S
FiltroGrupo1=MFAConceptoGASCfg.Clase
FiltroValida1=Clase
FiltroGrupo2=MFAConceptoGASCfg.SubClase
FiltroValida2=SubClase
FiltroTodo=S
FiltroNull=S
...
FiltroGeneral=Modulo=<T>{Info.Modulo}<T>
[Lista.Columnas]
Concepto=400
Bloqueo=90
Orden=36
...
[Lista.MFAConceptoGASCfg.Concepto]
Carpeta=Lista
Clave=MFAConceptoGASCfg.Concepto
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.MFAConceptoGASCfg.EsImportacion]
Carpeta=Detalle
Clave=MFAConceptoGASCfg.EsImportacion
Editar=S
LineaNueva=S
...
[Detalle.MFAConceptoGASCfg.MFAEsDeducible]
Carpeta=Detalle
Clave=MFAConceptoGASCfg.MFAEsDeducible
Editar=S
LineaNueva=S
3D=S
Tamano=15
...
(Inicio)=MFAConceptoGASCfg.MFAEsDeducible
MFAConceptoGASCfg.MFAEsDeducible=MFAConceptoGASCfg.EsImportacion
MFAConceptoGASCfg.EsImportacion=(Fin)
