...
FiltroRespetar=S
FiltroTipo=General
IconosNombre=AnexoCta:AnexoCta.Orden
FiltroGeneral=AnexoCta.Rama=<T>{Info.Rama}<T> AND AnexoCta.Cuenta=<T>{Info.Cuenta}<T>
...
NombreEnBoton=S
AntesExpresiones=RegistrarListaSt(<T>Lista<T>, <T>AnexoCta.Nombre<T>)<BR>EjecutarSQL(<T>spOrdenarMaestro :nEstacion, :tTabla, :tModulo, NULL, :tCuenta<T>, EstacionTrabajo, <T>AnexoCta<T>, Info.Rama, Info.Cuenta)
