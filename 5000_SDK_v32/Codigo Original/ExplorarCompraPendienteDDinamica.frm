[Forma]
Clave=ExplorarCompraPendienteDDinamica
Nombre=<T>Explotando Información - Compras Pendientes<T>
Icono=47
Modulos=(Todos)
ListaCarpetas=Lista
...
Zona=A1
Vista=CompraPendienteDDinamica
...
FiltroListasAplicaEn=CompraPendienteD.Articulo
