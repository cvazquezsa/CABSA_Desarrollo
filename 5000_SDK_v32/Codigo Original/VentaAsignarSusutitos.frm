...
Antes=S
DespuesGuardar=S
AntesExpresiones=EjecutarSQL(<T>spVentaAsignarSusutitosAceptar :nEstacion, :nID, :nRenglon, :nRenglonSub, :nRenglonID, :tArt, :tSub<T>, EstacionTrabajo, Info.ID, Info.Renglon, Info.RenglonSub, Info.RenglonID, Info.Articulo, Info.SubCuenta)
