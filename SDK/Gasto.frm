...
Boton=0
Menu=&Edición
NombreDesplegar=Información Complemento Enajenación Acciones SAT
GuardarAntes=S
EnMenu=S
EspacioPrevio=S
TipoAccion=Expresion
...
Expresion=Si<BR>    ConDatos(Info.Concepto) = Falso<BR>Entonces<BR>    Asigna(Info.Concepto, Mayusculas(SQL(<T>SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(concepto, :tA1, :tA2), :tE1, :tE2), :tI1, :tI2), :tO1, :tO2), :tU1, :tU2) FROM GASTOD WHERE ID = :nID<T>,<T>á<T>, <T>a<T>, <T>é<T>,<T>e<T>, <T>í<T>, <T>i<T>, <T>ó<T>, <T>o<T>, <T>ú<T>,<T>u<T>,Gasto:Gasto.ID)))<BR>Sino<BR>    Si<BR>        Info.Concepto <> <T>ENAJENACION DE ACCIONES<T><BR>    Entonces<BR>            Asigna(Info.Concepto, Mayusculas(SQL(<T>SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(concepto, :tA1, :tA2), :tE1, :tE2), :tI1, :tI2), :tO1, :tO2), :tU1, :tU2) FROM GASTOD WHERE ID = :nID<T>,<T>á<T>, <T>a<T>, <T>é<T>,<T>e<T>, <T>í<T>, <T>i<T>, <T>ó<T>, <T>o<T>, <T>ú<T>,<T>u<T>,Gasto:Gasto.ID)))<BR>    Fin<BR>Fin<BR>Si<BR>    Info.Concepto = <T>ENAJENACION DE ACCIONES<T><BR>Entonces<BR>    Si<BR>        SQL(<T>SELECT ISNULL(CFDRetencionTimbrado, 0) FROM Gasto WHERE ID = :nID<T>, Gasto:Gasto.ID) = Falso<BR>    Entonces<BR>        Forma(<T>CFDIEnajenacionGastoComplemento<T>)<BR>    Sino<BR>        Forma(<T>CFDIEnajenacionGastoComplementoInfo<T><BR>    Fin<BR>Sino<BR>    Si<BR>        Info.Concepto <> <T>ENAJENACION DE ACCIONES<T><BR>    Entonces<BR>        Error(<T>Funciona únicamente con el Concepto de Enajenacion de Acciones<T>)<BR>        Si<BR>            ConDatos(Info.Concepto) = Falso<BR>        Entonces<BR>            Asigna(Info.Concepto, Mayusculas(SQL(<T>SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(concepto, :tA1, :tA2), :tE1, :tE2), :tI1, :tI2), :tO1, :tO2), :tU1, :tU2) FROM GASTOD WHERE ID = :nID<T>,<T>á<T>, <T>a<T>, <T>é<T>,<T>e<T>, <T>í<T>, <T>i<T>, <T>ó<T>, <T>o<T>, <T>ú<T>,<T>u<T>,Gasto:Gasto.ID)))<BR>        Sino<BR>            Si<BR>                Info.Concepto <> <T>ENAJENACION DE ACCIONES<T><BR>            Entonces<BR>                Asigna(Info.Concepto, Mayusculas(SQL(<T>SELECT REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(concepto, :tA1, :tA2), :tE1, :tE2), :tI1, :tI2), :tO1, :tO2), :tU1, :tU2) FROM GASTOD WHERE ID = :nID<T>,<T>á<T>, <T>a<T>, <T>é<T>,<T>e<T>, <T>í<T>, <T>i<T>, <T>ó<T>, <T>o<T>, <T>ú<T>,<T>u<T>,Gasto:Gasto.ID)))<BR>            Fin<BR>        Fin<BR>            Si<BR>                Info.Concepto = <T>ENAJENACION DE ACCIONES<T><BR>            Entonces<BR>                Si<BR>                    SQL(<T>SELECT ISNULL(CFDRetencionTimbrado, 0) FROM Gasto WHERE ID = :nID<T>, Gasto:Gasto.ID) = Falso<BR>                Entonces<BR>                    Forma(<T>CFDIEnajenacionGastoComplemento<T>)<BR>                Sino<BR>                    Forma(<T>CFDIEnajenacionGastoComplementoInfo<T>)<BR>                Fin<BR>            Sino<BR>                Si<BR>                    Info.Concepto <> <T>ENAJENACION DE ACCIONES<T><BR>                Entonces<BR>                    Error(<T>Funciona únicamente con el Concepto de Enajenacion de Acciones<T>)<BR>                Sino<BR>                    Error(<T>Funciona únicamente para el Complemento Enajenacion de Acciones<T>)<BR>                Fin<BR>            Fin<BR>                Sino<BR>                    Error(<T>Funciona únicamente para el Complemento Enajenacion de Acciones<T>)<BR>                Fin<BR>            Fin
